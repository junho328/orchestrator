...
SAVE_COMPLETIONS=${SAVE_COMPLETIONS:-True}
SAVE_COMPLETIONS_PATH=${SAVE_COMPLETIONS_PATH:-"/home/work/aipr-jhna/output/completions"}
...
PUBLIC_AGENT_MAX_COMPLETION_LENGTH=${PUBLIC_AGENT_MAX_COMPLETION_LENGTH:-512}
PRIVATE_AGENT_MAX_COMPLETION_LENGTH=${PRIVATE_AGENT_MAX_COMPLETION_LENGTH:-1024}
...
nohup accelerate launch \
    ...
    --save_completions_path "$SAVE_COMPLETIONS_PATH" \
